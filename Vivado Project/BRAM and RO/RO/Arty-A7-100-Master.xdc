...
set_property -dict { PACKAGE_PIN F5    IOSTANDARD LVCMOS33 } [get_ports { clk }]; #IO_0_35 Sch=ck_a[0]
set_property -dict { PACKAGE_PIN D8    IOSTANDARD LVCMOS33 } [get_ports { check }]; #IO_L4P_T0_35 Sch=ck_a[1]

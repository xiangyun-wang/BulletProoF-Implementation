...
set_property -dict { PACKAGE_PIN F5    IOSTANDARD LVCMOS33 } [get_ports { output }]; #IO_0_35 Sch=ck_a[0]
set_property -dict { PACKAGE_PIN D8    IOSTANDARD LVCMOS33 } [get_ports { vec_out }]; #IO_L4P_T0_35 Sch=ck_a[1]
...
#set_property LOC SLICE_X0Y0  [get_cells ro_loop[0].flip];
#set_property LOC SLICE_X0Y1  [get_cells ro_loop[1].flip];
#set_property LOC SLICE_X0Y2  [get_cells ro_loop[2].flip];
#set_property LOC SLICE_X0Y3  [get_cells ro_loop[3].flip];
#set_property LOC SLICE_X0Y4  [get_cells ro_loop[4].flip];
#set_property LOC SLICE_X0Y5  [get_cells ro_loop[5].flip];
#set_property LOC SLICE_X0Y6  [get_cells ro_loop[6].flip];
#set_property LOC SLICE_X0Y7  [get_cells ro_loop[7].flip];
#set_property LOC SLICE_X0Y8  [get_cells ro_loop[8].flip];
#set_property LOC SLICE_X0Y9  [get_cells ro_loop[9].flip];
#set_property LOC SLICE_X0Y10  [get_cells ro_loop[10].flip];
#set_property LOC SLICE_X0Y11  [get_cells ro_loop[11].flip];
#set_property LOC SLICE_X0Y12  [get_cells ro_loop[12].flip];
#set_property LOC SLICE_X0Y13  [get_cells ro_loop[13].flip];
#set_property LOC SLICE_X0Y14  [get_cells ro_loop[14].flip];
#set_property LOC SLICE_X0Y15  [get_cells ro_loop[15].flip];
#set_property LOC SLICE_X0Y16  [get_cells ro_loop[16].flip];
#set_property LOC SLICE_X0Y17  [get_cells ro_loop[17].flip];
#set_property LOC SLICE_X0Y18  [get_cells ro_loop[18].flip];
#set_property LOC SLICE_X0Y19  [get_cells ro_loop[19].flip];
#set_property LOC SLICE_X0Y20  [get_cells ro_loop[20].flip];
#set_property LOC SLICE_X0Y21  [get_cells ro_loop[21].flip];
#set_property LOC SLICE_X0Y22  [get_cells ro_loop[22].flip];
#set_property LOC SLICE_X0Y23  [get_cells ro_loop[23].flip];
#set_property LOC SLICE_X0Y24  [get_cells ro_loop[24].flip];
#set_property LOC SLICE_X0Y25  [get_cells ro_loop[25].flip];
#set_property LOC SLICE_X0Y26  [get_cells ro_loop[26].flip];
#set_property LOC SLICE_X0Y27  [get_cells ro_loop[27].flip];
#set_property LOC SLICE_X0Y28  [get_cells ro_loop[28].flip];
#set_property LOC SLICE_X0Y29  [get_cells ro_loop[29].flip];
#set_property LOC SLICE_X0Y30  [get_cells last];


#set_property ALLOW_COMBINATORIAL_LOOPS TRUE [get_nets -of_objects [get_cells first]];
#set_property SEVERITY {Warning} [get_drc_checks LUTLP-1];
#set_property SEVERITY {Warning} [get_drc_checks NSTD-1];

#create_clock -period 10.000 -name clk_created -waveform {0.000 5.000} [get_ports CLK]

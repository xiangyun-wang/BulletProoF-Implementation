...
set_property -dict { PACKAGE_PIN A8    IOSTANDARD LVCMOS33 } [get_ports Calibration]; #IO_L12N_T1_MRCC_16 Sch=sw[0]
set_property -dict { PACKAGE_PIN C11   IOSTANDARD LVCMOS33 } [get_ports Signal_Measure]; #IO_L13P_T2_MRCC_16 Sch=sw[1]
...
set_property -dict { PACKAGE_PIN E1    IOSTANDARD LVCMOS33 } [get_ports Debug_Out_2]; #IO_L18N_T2_35 Sch=led0_b
#set_property -dict { PACKAGE_PIN F6    IOSTANDARD LVCMOS33 } [get_ports { LED[7] }]; #IO_L19N_T3_VREF_35 Sch=led0_g
#set_property -dict { PACKAGE_PIN G6    IOSTANDARD LVCMOS33 } [get_ports { led0_r }]; #IO_L19P_T3_35 Sch=led0_r
set_property -dict { PACKAGE_PIN G4    IOSTANDARD LVCMOS33 } [get_ports Debug_Out_3]; #IO_L20P_T3_35 Sch=led1_b
...
set_property -dict { PACKAGE_PIN J2    IOSTANDARD LVCMOS33 } [get_ports Calibration_Finished]; #IO_L22N_T3_35 Sch=led2_g
...
set_property -dict { PACKAGE_PIN H5    IOSTANDARD LVCMOS33 } [get_ports Debug_Out_1]; #IO_L24N_T3_35 Sch=led[4]
...
set_property -dict { PACKAGE_PIN D9    IOSTANDARD LVCMOS33 } [get_ports Launch]; #IO_L6N_T0_VREF_16 Sch=btn[0]
...
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports {Point_Sel[0]}]; #IO_L16P_T2_CSI_B_14 Sch=ck_io[0]
set_property -dict { PACKAGE_PIN U16   IOSTANDARD LVCMOS33 } [get_ports { Point_Sel[1] }]; #IO_L18P_T2_A12_D28_14 Sch=ck_io[1]
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { Point_Sel[2] }]; #IO_L8N_T1_D12_14 Sch=ck_io[2]
set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { Point_Sel[3] }]; #IO_L19P_T3_A10_D26_14 Sch=ck_io[3]
...
set_property -dict { PACKAGE_PIN N15   IOSTANDARD LVCMOS33 } [get_ports { Calibrated_Points[0] }]; #IO_L11P_T1_SRCC_14 Sch=ck_io[8]
set_property -dict { PACKAGE_PIN M16   IOSTANDARD LVCMOS33 } [get_ports { Calibrated_Points[1] }]; #IO_L10P_T1_D14_14 Sch=ck_io[9]
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { Calibrated_Points[2] }]; #IO_L18N_T2_A11_D27_14 Sch=ck_io[10]
set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { Calibrated_Points[3] }]; #IO_L17N_T2_A13_D29_14 Sch=ck_io[11]
set_property -dict { PACKAGE_PIN R17   IOSTANDARD LVCMOS33 } [get_ports { Calibrated_Points[4] }]; #IO_L12N_T1_MRCC_14 Sch=ck_io[12]
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { Calibrated_Points[5] }]; #IO_L12P_T1_MRCC_14 Sch=ck_io[13]
...
set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { Delay_Out[0] }]; #IO_L19N_T3_A09_D25_VREF_14 Sch=ck_io[26]
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { Delay_Out[1] }]; #IO_L16N_T2_A15_D31_14 Sch=ck_io[27]
set_property -dict { PACKAGE_PIN M13   IOSTANDARD LVCMOS33 } [get_ports { Delay_Out[2] }]; #IO_L6N_T0_D08_VREF_14 Sch=ck_io[28]
set_property -dict { PACKAGE_PIN R10   IOSTANDARD LVCMOS33 } [get_ports { Delay_Out[3] }]; #IO_25_14 Sch=ck_io[29]
set_property -dict { PACKAGE_PIN R11   IOSTANDARD LVCMOS33 } [get_ports { Delay_Out[4] }]; #IO_0_14 Sch=ck_io[30]
set_property -dict { PACKAGE_PIN R13   IOSTANDARD LVCMOS33 } [get_ports { Delay_Out[5] }]; #IO_L5N_T0_D07_14 Sch=ck_io[31]
set_property -dict { PACKAGE_PIN R15   IOSTANDARD LVCMOS33 } [get_ports { Delay_Out[6] }]; #IO_L13N_T2_MRCC_14 Sch=ck_io[32]
set_property -dict { PACKAGE_PIN P15   IOSTANDARD LVCMOS33 } [get_ports { Delay_Out[7] }]; #IO_L13P_T2_MRCC_14 Sch=ck_io[33]
...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets Calibration_IBUF]
